...
type HealderAdapter interface {
	...
	ListRedeemRequests(ctx context.Context, address common.Address, page, size int32) ([]sqlc.RedeemRequestWithCommand, int64, error)
	...
	SubmitRedeemCommandSignatures(ctx context.Context, ids [][]byte, signature [][]byte, executeData [][]byte) error
